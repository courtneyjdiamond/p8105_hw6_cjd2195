...
Cool, for the first bootstrapped sample, we can see that there are many dates which were pulled more than once (e.g. January 2, January 3, January 7, etc. etc.)
...
Hooray! Let's plot them. It's important to note that, because many of the beta_2 values calculated are negative, the log(beta_1 * beta_2) value is going to be NaN for these samples, and thus will be dropped when plotting the distribution.
